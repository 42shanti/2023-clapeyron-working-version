...
plt.semilogx(ρ_l_exp[2:2:end],T_exp[2:2:end],label="Experimental-l",marker="o",linestyle="",color="k")
plt.semilogx(ρ_v_exp[2:2:end],T_exp[2:2:end],label="Experimental-v",marker="o",linestyle="",color="dimgray")
