...
# Plotting:
plt.clf()
plt.plot(1e-3 ./v_l[1],T[1],label="eCPA-EAN1A",linestyle=":",color="r")
# plt.plot(1e-3 ./v_v[1],T[1],label="",linestyle=":",color="r")
plt.plot(1e-3 ./v_l[2],T[2],label="eCPA-EAN2B",linestyle="--",color="g")
# plt.plot(1e-3 ./v_v[2],T[2],label="",linestyle="--",color="g")
plt.plot(1e-3 ./v_l[3],T[3],label="eCPA-EAN4C",linestyle="-.",color="b")
